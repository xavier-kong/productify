...
For the project, the most common operations will be reading tasks, adding tasks and editing tasks. As the data could be nested, there could be advantages of using GraphQL.
